...
const Header = ()=> (
  <div className = "header">
      ...
      <div className = 'options'>
          ...
          <Link to = '/ABOUT-US' className='option'>About us</Link>
          <Link to = '/DIVISION' className='option'> Division</Link>
          <Link to = '/VISSION-&-MISSION' className='option'>Vission & Mission</Link>
          <Link to = '/CAREERS' className='option'>Carrers</Link>
          <Link to = '/CONTACT-US' className='option'>Contact us</Link>
          <Link to = '/CEO-MESSAGE' className='option'>Ceo Message</Link>
