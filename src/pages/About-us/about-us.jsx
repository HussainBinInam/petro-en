...
const AboutUs = () => {
  return (
    <div>
      ...
      <img src={Image} />
      <p>
        Petroen Engineering DMCC started its operation in Dubai, United Arab Emirates in 2007.
      </p>
      <p>
        Petroen Engineering DMCC is one the most trusted names in the market of Engineering
