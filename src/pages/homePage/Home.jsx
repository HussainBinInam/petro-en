   ...
   return ( <div className = 'homePage'>
        <div className= "intro">
            <h2 >Welcome to ProTech</h2>
                ...
                <div className= "para">
                    <p>
                        ProTech is an integrated Engineering, Procurement, Construction and Commissioning (EPCC) company; recognized as a “committed service provider” by the Exploration & Production companies.</p>
                    <img src={PTP} alt= "power transmission products"/>
                    <p>
                        Our primary expertise in oil & gas and energy sectors are Providing seamless services for production & processing equipment, their related utilities.
                        Setting up complete production & processing facilities on turnkey basis.
